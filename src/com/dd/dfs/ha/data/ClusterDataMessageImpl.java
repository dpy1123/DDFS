 ...
 * 
 */
public class ClusterDataMessageImpl extends ClusterMessageBase implements ClusterDataMessage {
    
    private static final long serialVersionUID = 1L;

    public ClusterDataMessageImpl() {
    }
     ...
     *    after GET_ALL_SESSION received from this sender.<BR>
     * @param contextName - 发出该消息的上下文的名称，上下文可能由发送方的container+Manager构成
     ...
     */
	public ClusterDataMessageImpl(String contextName, int eventtype, byte[] data, String dataID, String uniqueID) {
    ...
    public String toString() {
        return getEventTypeString() + "#" + getContextName() + "#" + getDataID() ;
    }
}
